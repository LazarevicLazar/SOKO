...
if NVCC=$(detect_nvcc); then
    ...
    if CL_DIR=$(detect_cl_dir); then
        ...
        CU_FILE_WIN=$(to_windows_path "$CUDA_DIR/soko_gpu_offline.cu")
...
"$CC" $CFLAGS $GPU_DEFS -I"$INCLUDE_DIR" -I"$ROOT_DIR" -I"$FALCON_DIR" \
    -c "$BENCH_DIR/soko_refill_simulator.c" -o "$BUILD_DIR/soko_refill_simulator.o"
...
echo
echo "Linking $TARGET..."
"$CC" $CFLAGS $LDFLAGS -o "$BUILD_DIR/$TARGET.exe" "$BUILD_DIR/soko_refill_simulator.o" \
    "$BUILD_DIR/soko_falcon_common.o" "$BUILD_DIR/soko_cpu_backend.o" \
    "$BUILD_DIR/soko_cpumt_backend.o" "$BUILD_DIR/soko_gpu_backend.o" \
    "$BUILD_DIR/soko_falcon_pipeline.o" \
    "$BUILD_DIR/msim_fal_codec.o" "$BUILD_DIR/msim_fal_common.o" \
    "$BUILD_DIR/msim_fal_falcon.o" "$BUILD_DIR/msim_fal_fft.o" \
    "$BUILD_DIR/msim_fal_fpr.o" "$BUILD_DIR/msim_fal_keygen.o" \
    "$BUILD_DIR/msim_fal_rng.o" "$BUILD_DIR/msim_fal_shake.o" \
    "$BUILD_DIR/msim_fal_sign.o" "$BUILD_DIR/msim_fal_vrfy.o" \
    $LIBS
