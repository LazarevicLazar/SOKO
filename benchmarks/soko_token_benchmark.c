/*
 * SOKO Token Benchmark
 *
 * Goal:
 * - Generate offline pre-sign bank for token batches (8/128/1024/8192/65536)
 * - Compare CPU-offline, CPUMT, and SOKO GPU-offline bank generation
 * - Keep online signing on CPU
 *
 * Notes:
 * - This benchmark is intentionally separate from the certificate-chain benchmarks.
...
int main(int argc, char **argv)
{
    ...
    printf("===============================================================\n");
    printf("SOKO TOKEN BENCHMARK (GPU offline, CPU online)\n");
